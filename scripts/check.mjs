...
for (const file of htmlFiles) {
  ...
  for (const match of html.matchAll(/(?:src|href)="(\/series-65-exam-prep-web\/[^"?#]+)"/g)) {
    const pathname = match[1].replace("/series-65-exam-prep-web/", "");
...
if (htmlFiles.length !== 22) failures.push(`expected 22 HTML files, found ${htmlFiles.length}`);
if (failures.length) {
